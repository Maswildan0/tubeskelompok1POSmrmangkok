    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="bootstrap-tabs product-tabs">
          <a href="/depan" class="btn btn-outline-secondary">
            &larr; Kembali
          </a>
                  ...
                  <div class="product-item">
                    ...
                    <figure>
                      <a href="{{ Storage::url($p->gambar) }}" title="Product Title">
                        <img src="{{ Storage::url($p->gambar) }}" class="img-fluid">
                      </a>
                    </figure>
                    <h3>{{$p->nama}}</h3>
  ...
  function hapus(menu_id) {
        ...
        .then(data => {
            if (data.success) {
                ...
                // Format total harga dengan format IDR
                ...
                // Memastikan elemen dengan id 'cart-total' ada sebelum mengubahnya
                let cartTotal = document.getElementById('cart-total');
                if (cartTotal) {
                    cartTotal.textContent = "Total: " + vtotal;
                }

                // Memastikan elemen dengan id 'total_belanja' ada sebelum mengubahnya
                let totalBelanja = document.getElementById('total_belanja');
                if (totalBelanja) {
                    totalBelanja.textContent = vtotal;
                }

                // Memastikan elemen dengan id 'cart-count' ada sebelum mengubahnya
                let cartCount = document.getElementById('cart-count');
                if (cartCount) {
                    cartCount.textContent = data.jmlmenudibeli;
                }
